...
namespace Wiggle.Domain.Tests.ShoppingBasket
{
    ...
    {
        [TestMethod]
        public void Client_Ensure_ShoppingBasketService_Returns_Total_65_15()
        {
            var repo = A.Fake<IRepository>();
            var logger = A.Fake<ILogger>();

            var service = new Wiggle.Client.Test.ShoppingBasketService.ShoppingBasketServiceContractClient();
        ...
        [TestMethod]
        public void Client_Ensure_ShoppingBasketService_Returns_Total_51_With_No_HeadGear_Offer_Applied()
        {
            var repo = A.Fake<IRepository>();
            var logger = A.Fake<ILogger>();
        ...
        [TestMethod]
        public void Client_Ensure_ShoppingBasketService_Returns_Total_51_With_HeadGear_Offer_Applied()
        {
            var repo = A.Fake<IRepository>();
            var logger = A.Fake<ILogger>();
        ...
        [TestMethod]
        public void Client_Ensure_ShoppingBasketService_Returns_Total_41_With_Offer_And_GiftVoucher_Applied()
        {
            var repo = A.Fake<IRepository>();
            var logger = A.Fake<ILogger>();
